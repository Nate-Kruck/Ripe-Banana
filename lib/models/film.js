...
module.exports = class Film {
    ...
    static async findById(id) {
      ...
      const cast = await Character.getCastByFilmId(id);
      const review = await Review.findByFilmId(id);
      const foundFilm = new Film(rows[0]);
      console.log({ ...foundFilm, cast, reviews: review });
      return { ...foundFilm, cast };
